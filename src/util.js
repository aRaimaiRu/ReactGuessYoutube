...
//    console.log(t.vote1)
    ...
    const filterKeyArray = createNumeralArray(Object.keys( t.vote1 ).length)
                    .reduce((sum,c) => t.vote1[c]>3?[...sum,c]:sum, [])
    ...
    console.log( {key:newKey,name:newName,vote1:newVote1,vote2:newVote2,year:newYear})
    return {key:newKey,name:newName,vote1:newVote1,vote2:newVote2,year:newYear}
}
